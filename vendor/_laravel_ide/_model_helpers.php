...
namespace App\Models {
     ...
     *
     * @method static \Illuminate\Database\Eloquent\Builder<CompanyProject>|CompanyProject newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CompanyProject>|CompanyProject newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CompanyProject>|CompanyProject query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class CompanyProject extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
